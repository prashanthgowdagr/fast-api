...
```
cd existing_repo
git remote add origin http://gitlab.q21.in/pgr/fast-api.git
git branch -M main
...
- [ ] [Set up project integrations](http://gitlab.q21.in/pgr/fast-api/-/settings/integrations)
